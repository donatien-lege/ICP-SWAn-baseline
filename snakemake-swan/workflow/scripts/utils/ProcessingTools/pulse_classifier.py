...
from utils.ProcessingTools.model.ResnetModel import ResNet
...
class Classifier:
    def __init__(self, params: dict) -> None:
        ...
        self.model.load_state_dict(torch.load(self.model_weights, map_location=self.device, weights_only=True)["state_dict"])
        self.model.eval()
